        ...
        <div class="card-body">
            ...
            <div class="d-sm-flex align-items-center justify-content-lg-between ">
                <form method="post">
                    ...
                    <label>
                        <button type="submit" class="btn btn-outline-primary">Akceptuj</button>
                    </label>

                    <label>
                        <button type="reset" class="btn btn-outline-primary" onclick="window.location='/users/list'">Anuluj</button>
                    </label>
                </form>
            </div>
        </div>
